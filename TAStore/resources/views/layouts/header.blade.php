    ...
    <div class="row display-flex">
      <div class="col-md-2 margin-auto trigger-menu">
        ...
        <div class="logo" >
          ...
          <h2 style=" font-size: 35px; padding-bottom: 10px" class="logo-wrapper" href="{{ route('home_page') }}" title="{{ config('app.name') }}"><strong>TAStore</strong></h2>
        </div>
      </div>
      ...
      <div class="col-md-7 hd-bg-white main-menu-responsive" style="padding-top: 10px; color:black; ">
        <div class="main-menu">
          <div class="nav">
            <ul>
